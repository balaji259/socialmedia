...
const DiscussionPage = () => {
  ...
  const [communityName, setCommunityName] = useState("Community Discussion");
  ...
  const fetchMessages = async () => {
    try {
      const response = await axios.get(`/community/${id}/getdiscussions`);
  ...
  useEffect(() => {
    ...
    console.log("Joining community room:", id);
