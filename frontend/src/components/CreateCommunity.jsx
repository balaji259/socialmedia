    ...
    <div className="min-h-screen bg-gray-100">
      <nav className="bg-[#3b5998] shadow-md p-4 flex justify-between items-center">
        ...
        <div className="space-x-4">
          <a onClick={()=>{navigate('/home')}} className="text-white cursor-pointer">Home</a>
          <a onClick={()=>{navigate('/profile')}} className="text-white cursor-pointer">Profile</a>
          <a onClick={()=>{navigate('/chats')}} className="text-white cursor-pointer">Messages</a>
          <a onClick={()=>{navigate('/notifications')}} className="text-white cursor-pointer">Notifications</a>
        </div>
      </nav>
